...
export const c3b2tugiac: MathTopic = {
  ...
  "theory": {
    ...
    "content": [
      ...
      [cite_start]"- Tứ giác ABCD là hình gồm bốn đoạn thẳng AB, BC, CD, DA, trong đó bất kì hai đoạn thẳng nào cũng không cùng nằm trên một đường thẳng. [cite: 588]",
      [cite_start]"- Tứ giác lồi là tứ giác luôn nằm trong một nửa mặt phẳng có bờ là đường thẳng chứa bất kì cạnh nào của tứ giác. [cite: 65]",
      ...
      [cite_start]"- Tổng số đo các góc của một tứ giác bằng $360^{\circ}$. [cite: 66]"
    ],
    "formulas": [
  ...
  "flashcards": [
    {
      ...
      [cite_start]"answer": "Tứ giác ABCD là hình gồm bốn đoạn thẳng AB, BC, CD, DA, trong đó bất kì hai đoạn thẳng nào cũng không cùng nằm trên một đường thẳng. [cite: 588]"
    },
    {
      "id": "2",
      "question": "Thế nào là một tứ giác lồi?",
      [cite_start]"answer": "Tứ giác lồi là tứ giác luôn nằm trong một nửa mặt phẳng có bờ là đường thẳng chứa bất kì cạnh nào của tứ giác. [cite: 65]"
    },
    {
      "id": "3",
      "question": "Tổng số đo các góc của một tứ giác là bao nhiêu?",
      [cite_start]"answer": "Tổng số đo các góc của một tứ giác bằng $360^{\circ}$. [cite: 66]"
    }
  ],
  "examples": [
    {
      ...
      "solution": [
        [cite_start]"Xét tứ giác MNPQ, áp dụng định lí tổng các góc của một tứ giác, ta có: [cite: 66]",
